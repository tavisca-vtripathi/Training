...
using Tavisca.MVCAuthorisation.Helper;
...
namespace RoleBasedAuthentication_MVC_.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            EmployeeResponse employee = credentials.Authenticate(credentials);
            ...
            {
                CreateAuthenticationTicket(employee.Employee);
                if (string.Equals(employee.Employee.Title, "HR", StringComparison.OrdinalIgnoreCase))
                    returnUrl = "HR/AddRemarks";
        ...
        public void CreateAuthenticationTicket(Employee employee)
        {
            ...
            serializeModel.EmpId = employee.Id;
            ...
            if (HttpContext.User.Identity != null)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        ...
                        changePassword.EmailId = User.Identity.Name;
                        changePassword.OldPassword = model.OldPassword;
                        changePassword.NewPassword = model.NewPassword;
                        var result = changePassword.UpdatePassword(changePassword);
